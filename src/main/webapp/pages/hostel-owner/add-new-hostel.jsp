        ...
        <div class="col-12 col-lg-9 col-xl-9 col-xxl-10 content-group">
            ...
            <div class="row mb-5">
                <div class="content-body col-12 col-md-10 col-lg-9 col-xl-8 m-auto">
                    <form action="add-new-hostel" method="POST" class="custom-form add-hostel-form"
                          id="add-hostel-form">
                                ...
                                <div class="col-12 col-md-10 m-auto">
                                    <div class="form-group price-service-fill">
                                        <div class="fill-group">
                                            <label for="hostel-electric" class="form-label fill-label">Điện:
                                                <span>*</span></label>
                                            <input id="hostel-electric" name="hostel-electric" value="3500"
                                    ...
                                    <div class="form-group price-service-fill">
                                        <div class="fill-group">
                                            ...
                                            <input id="hostel-wifi" name="hostel-wifi" value="100000" type="number"
                                                   placeholder="Nhập giá"
                                    ...
                                    <div class="form-group price-service-fill">
                                        <div class="fill-group">
                                            ...
                                            <input id="hostel-manage" name="hostel-manage" value="30000" type="number"
                                                   placeholder="Nhập giá"
                                                   class="form-control fill-input">
                                            <span class="fill-unit">VNĐ/phòng</span>
                                        </div>
                                    ...
                                    <div class="form-group price-service-fill">
                                        <div class="fill-group">
                                            ...
                                            <input id="hostel-vehicle" name="hostel-vehicle" value="10000" type="number"
                                                   placeholder="Nhập giá"
                                                   class="form-control fill-input">
                                            <span class="fill-unit">VNĐ/phòng</span>
                                        </div>
                                    ...
                                    <div class="form-group price-service-fill">
                                        <div class="fill-group">
                                            <label for="hostel-cleaning" class="form-label fill-label">Phí vệ sinh:
                                                <span>*</span></label>
                                            <input id="hostel-cleaning" name="hostel-cleaning" value="10000"
                                                   placeholder="Nhập giá"
                                                   type="number" class="form-control fill-input">
                                            <span class="fill-unit">VNĐ/phòng</span>
                                        </div>
