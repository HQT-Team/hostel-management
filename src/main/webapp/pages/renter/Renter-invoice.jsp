...
<head>
  ...
  <link rel="stylesheet" href="./assets/css/renter_page/Renter-invoice.css">
    ...
    <div class="main-body row">
        ...
        <div class="card">
          ...
          <div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordion">
            <div class="card-body">
              ...
              <h3><a href="Renter-bill" style="color:rgb(4, 4, 255)">Hóa đơn</a></h3>
      ...
      <div class="content row">
        <div class="invoice">
          ...
          <p>Giá điện: </p>
          <p>Giá nước: </p>
          <!-- lấy infastructure của phòng này -->
          <p></p>
