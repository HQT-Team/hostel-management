                ...
                <table class="table">
                    ...
                    <c:forEach items="${listroommateinfor}" var="roommateinfor">
                        <tr>
                            ...
                            <td><a href="Renter-update-roommate?roommateID=${roommateinfor.roommateID}" role="button"
                                   class="btnAction">Chỉnh Sửa</a></td>
                        </tr>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="copyright-wrapper d-flex justify-content-center">
                        ...
                        <div class="copyright-content" style="font-size: 18px;">© 2022 HQT Team. All rights reserved.
                        </div>
                    </div>
                </div>
            </div>
