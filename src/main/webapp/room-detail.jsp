                        ...
                        <div class="row">
                            <div class="col-12 col-md-7 room-information__left">
                                <div class="infor-group">Khu trọ trực thuộc:
                                    <span> ${requestScope.roomInformation.roomInformation.hostelName} </span></div>
                                <div class="infor-group">Địa chỉ:
                                    <span> ${requestScope.roomInformation.roomInformation.address}, Q. ${requestScope.roomInformation.roomInformation.district}, TP. ${requestScope.roomInformation.roomInformation.city} </span>
                                </div>
                                <div class="infor-group">Số lượng thành viên:
                                    <span>?/${requestScope.roomInformation.capacity} </span></div>
                            </div>
                        ...
                        <div class="col-12 col-lg-5 col-xl-4">
                            ...
                            <div class="room-consume">
                                ...
                                <div class="consume-update-date">Ngày cập nhật gần nhất: <span
                                        class="date">${requestScope.consumeRoom.endConsumeDate}
<%--                                            <span class="count-date">(?? ngày trước)</span>--%>
                                    </span></div>
                            ...
                            <div class="room-invoice">
                                ...
                                <div class="invoice-body">
                                    ...
                                    <div class="invoice-group">
                                        ...
                                        <div class="invoice-content price">${requestScope.billRoom.totalMoney}<span> VNĐ</span>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="room-members">
                                <div class="members-header">
                                    <div class="members-title">Danh sách trang thiết bị phòng</div>
                                    <div class="members-actions">
                                        <button class="add-member-btn">Thêm trang thiết bị</button>
                                    </div>
                                </div>
                                <table id="infrastructure-table"
                                    ...
                                    <tr>
                                        <th class="mobile-display-none">STT</th>
                                        <th>Tên thiết bị</th>
                                        <th class="mobile-display-none">Số lượng</th>
                                        <th class="mobile-display-none">Tình trạng</th>
                                        <th>Hành động</th>
                                    </tr>
                                    </thead>
                                    <tbody class="table-light">
                                    ...
                                    <c:forEach var="infrastructures" items="${requestScope.infrastructures}">
                                        <tr>
                                            ...
                                            <td class="mobile-display-none">${infrastructures.quantity}</td>
                                            <td class="mobile-display-none">
                                                <c:choose>
                                                    <c:when test="${infrastructures.status eq 1}">Tốt</c:when>
